...
echo [13/14] Running 012... 🆕 BE-4: Print-ready PDF
psql -U postgres -d healthcare_db -f database/migrations/012_add_print_fields.sql

echo [14/14] Running 013... 🆕 BE-4: Report History/Versioning
psql -U postgres -d healthcare_db -f database/migrations/013_add_scan_versioning.sql

echo.
echo  ✅ ALL DONE! (14 migrations completed)
pause